...
class WC_AlphaPay_UnionPay extends WC_Payment_Gateway{


  public function __construct(){
    // The global ID for this Payment method
    $this->id = "alphapay_unionpay";

    // The Title shown on the top of the Payment Gateways Page next to all the other Payment Gateways
    $this->method_title='AlphaPay - UnionPay';
    ...
    // If you want to show an image next to the gateway's name on the frontend, enter a URL to an image.
		// $this->icon = ALPHAPAY_URL. '/assets/images/unionpay-logo.png';
  ...
  public function get_icon() {
    ...
    $icons_str = '<img src="' . ALPHAPAY_URL . '/assets/images/unionpay-logo.png" class="right-float" alt="UnionPay" />';
  ...
  public function is_available() {
      ...
      if(get_woocommerce_currency() == 'CNY' && AlphaPay_API::get_currency() == 'USD') {
          return false;
      }
  ...
  function init_form_fields() {
    $this->form_fields = array (
      'enabled' => array (
        ...
        'type' => 'checkbox',
        'label' => 'Enable AlphaPay - UnionPay',
        'default' => 'no',
        'section' => 'default'
      ),
      'title' => array (
      ...
      'description' => array (
        'title' => 'Description',
        'type' => 'textarea',
        'default' => 'Use UnionPay App to scan QR Code to complete payment or pay with UnionPay card directly',
        'desc_tip' => true,
        'css' => 'width:400px',
        'section'=>'default'
      ),
     ...
     try{
       if($this->is_app_client()){
 				...
 				if('1'==$this->get_option('qrcode_redirect')){
 					$result = AlphaPay_API::generate_alphapay_order($order,'UnionPay',"/api/v1.0/web_gateway/partners/%s/orders/%s");
