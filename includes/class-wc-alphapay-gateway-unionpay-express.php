...
class WC_AlphaPay_UnionPay_Express extends WC_Payment_Gateway{


  public function __construct(){
    // The global ID for this Payment method
    $this->id = "alphapay_unionpay_express";

    // The Title shown on the top of the Payment Gateways Page next to all the other Payment Gateways
    $this->method_title='AlphaPay - UnionPay Credit';
    ...
    // If you want to show an image next to the gateway's name on the frontend, enter a URL to an image.
		// $this->icon = ALPHAPAY_URL. '/assets/images/unionpay-express-logo.png';
  ...
  public function get_icon() {
    ...
    $icons_str = '<img src="' . ALPHAPAY_URL . '/assets/images/unionpay-express-logo.png" class="right-float" alt="UnionPay" />';
  ...
  public function is_available() {
    ...
    if($order_currency == 'CNY' && $cny_request_currency == 'USD' || $order_currency == 'USD') {
        return false;
    }
  ...
  function init_form_fields() {
    $this->form_fields = array (
      'enabled' => array (
        ...
        'type' => 'checkbox',
        'label' => 'Enable AlphaPay - UnionPay Credit',
        'default' => 'no',
        'section' => 'default'
      ),
      'title' => array (
      ...
      'description' => array (
        'title' => 'Description',
        'type' => 'textarea',
        'default' => 'Pay with UnionPay card directly',
        'desc_tip' => true,
        'css' => 'width:400px',
        'section'=>'default'
      )
   ...
   public function process_payment( $order_id ) {
     ...
     try{
       if($this->is_app_client()){
 				$result = AlphaPay_API::generate_alphapay_order($order,'UnionPay',"/api/v1.0/h5_payment/partners/%s/orders/%s");
 			}else{
 				$result = AlphaPay_API::generate_alphapay_order($order,'UnionPayOnline',"/api/v1.0/gateway/partners/%s/pre_card_orders/%s");
 			}
